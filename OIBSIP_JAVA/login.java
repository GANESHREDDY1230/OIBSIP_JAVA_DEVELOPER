...
class OnlineTestBegin extends JFrame implements ActionListener
{
    ...
    void set()
    {
        ...
        if(current==1)
        {
            ...
            l.setFont(new Font("Arial", Font.PLAIN, 20));
            jb[0].setText(" Info");jb[1].setText("getInfo");jb[2].setText("getinfoof");jb[3].setText("instanceof");
            jb[0].setFont(new Font("Arial", Font.PLAIN, 20));
            jb[1].setFont(new Font("Arial", Font.PLAIN, 20));
            jb[2].setFont(new Font("Arial", Font.PLAIN, 20));
            jb[3].setFont(new Font("Arial", Font.PLAIN, 20));
        ...
        if(current==2)
        {
            ...
            l.setFont(new Font("Arial", Font.PLAIN, 20));
            jb[0].setText("String");jb[1].setText("RuntimeExceptions");jb[2].setText("Catchable");jb[3].setText("Throwable");
            jb[0].setFont(new Font("Arial", Font.PLAIN, 20));
            jb[1].setFont(new Font("Arial", Font.PLAIN, 20));
            jb[2].setFont(new Font("Arial", Font.PLAIN, 20));
            jb[3].setFont(new Font("Arial", Font.PLAIN, 20));
        ...
        if(current==3)
        {
            l.setText("4: Which of these components are used in a Java program for compilation, debugging, and execution?");
            l.setFont(new Font("Arial", Font.PLAIN, 20));
        ...
        if(current==4)
        {
            l.setText("5: What is it called when the child object also gets killed when the parent object is killed in the program?");
            l.setFont(new Font("Arial", Font.PLAIN, 20));
            jb[0].setText("Encapsulation");jb[1].setText("Association");jb[2].setText("Aggregation");jb[3].setText("Composition");
            jb[0].setFont(new Font("Arial", Font.PLAIN, 20));
            jb[1].setFont(new Font("Arial", Font.PLAIN, 20));
            jb[2].setFont(new Font("Arial", Font.PLAIN, 20));
            jb[3].setFont(new Font("Arial", Font.PLAIN, 20));
        ...
        if(current==5)
        {
            ...
            l.setFont(new Font("Arial", Font.PLAIN, 20));
            jb[0].setText(" ObjectNotFoundException");jb[1].setText(" IllegalStateException");jb[2].setText(" IOException");jb[3].setText("SystemException");
            jb[0].setFont(new Font("Arial", Font.PLAIN, 20));
            jb[1].setFont(new Font("Arial", Font.PLAIN, 20));
            jb[2].setFont(new Font("Arial", Font.PLAIN, 20));
            jb[3].setFont(new Font("Arial", Font.PLAIN, 20));
        ...
        if(current==6)
        {
            ...
            l.setFont(new Font("Arial", Font.PLAIN, 20));
            jb[0].setText("toString()");jb[1].setText("getString()");jb[2].setText("parse()");
        ...
        if(current==8)
        {
            ...
            l.setFont(new Font("Arial", Font.PLAIN, 20));
            jb[0].setText("Object clone()");jb[1].setText(" clone()");jb[2].setText("Object copy()");jb[3].setText("copy()");
            jb[0].setFont(new Font("Arial", Font.PLAIN, 20));
            jb[1].setFont(new Font("Arial", Font.PLAIN, 20));
            jb[2].setFont(new Font("Arial", Font.PLAIN, 20));
            jb[3].setFont(new Font("Arial", Font.PLAIN, 20));
